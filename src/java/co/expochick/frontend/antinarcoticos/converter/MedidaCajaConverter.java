 ...
 * @author Alexandra
 */
@FacesConverter (forClass = Medidacaja.class)
public class MedidaCajaConverter extends AbstractConverter {

    public MedidaCajaConverter() {
        this.nombreMBean = "medidaCajaListarController";
    }
